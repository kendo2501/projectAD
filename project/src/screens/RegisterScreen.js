...
try {
const action = await dispatch(register({ full_name: fullName, email, password, role }));
...
<TextInput style={styles.input} placeholder="Email" keyboardType="email-address" autoCapitalize="none" onChangeText={setEmail} value={email} />
